...
<%@ include file="./inc/signupform_link.jsp" %>
...
<div class="login-page" ng-app="">
  ...
  <div class="login-content login-content-signin" ng-hide="showSignIn">
    <div>
      <h2>Log in</h2>
      <form id="form1" class="wrapper-box">
        ...
        <button type="button" id="bt_login" class="btn btn-submit btn-default pull-right">Log in</button>
      </form>
    </div>
  </div>
  ...
  <div class="login-content login-content-signup ng-hide" ng-show="showSignIn">
    <div>
      <h2>Sign Up</h2>
      <form id="form2" class="wrapper-box">
        ...
        <button type="submit" id="bt_signup" class="btn btn-submit btn-default pull-right">Sign up</button>
      </form>
    </div>
  </div>
